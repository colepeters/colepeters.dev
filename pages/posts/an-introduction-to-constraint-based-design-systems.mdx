...
Over the past decade, the topic of design systems has exploded. Once confined to niche conversations on isolated corners of the internet, there are now multiple high profile conferences focusing exclusively on design systems for digital products. As such, you’ll have no trouble finding a litany of articles and presentations on this subject. However, a great many articles on design systems are directed at _either_ designers _or_ engineers, and as such, they often make use of terminology and domain knowledge that may not be familiar to the ‘visiting party’.

The approach behind this article is one that I’ve used with great success over the past 3 years while onboarding and mentoring multiple designers and engineers in the area of design systems. My goal has always been to get new designers and frontend engineers in the same room (or video chat), learning from the same material, and on the same page from day one. I’ve found this to be a hugely effective strategy in forming a strong shared perspective — an essential ingredient for collaborative cross-functional teams.

Accordingly, this article goes heavy on theory and application, and lighter on implementation. While some implementation details are necessarily touched on, this article is not meant to inform the specific implementation of a design system. Rather, my intent is to present a rigorous conceptual foundation from which any effective design system on the web may be constructed or analyzed.
